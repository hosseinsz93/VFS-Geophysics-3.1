...
void store_i_section(UserCtx *user, int iplane)
{
	...
	*/
	...
	if(temperature) DAVecGetArray(user->da, user->Tmprt, &tmprt); // add xiaolei
	if(temperature1) DAVecGetArray(user->da, user->Tmprt1, &tmprt1); // add xiaolei
	if(temperature2) DAVecGetArray(user->da, user->Tmprt2, &tmprt2); // add xiaolei
	if(temperature3) DAVecGetArray(user->da, user->Tmprt3, &tmprt3); // add xiaolei
	if(levelset) DAVecGetArray(user->da, user->Levelset, &level); // add xiaolei
	...
	if(temperature) DAVecRestoreArray(user->da, user->Tmprt, &tmprt); // add xiaolei
	if(levelset) DAVecRestoreArray(user->da, user->Levelset, &level); // add xiaolei
...
void store_j_section(UserCtx *user, int jplane)
{
	...
	*/
	...
	if(rans) DAVecRestoreArray(user->fda2, user->K_Omega, &komega);
	if(temperature) DAVecRestoreArray(user->da, user->Tmprt, &tmprt); // add xiaolei
	if(temperature1) DAVecRestoreArray(user->da, user->Tmprt1, &tmprt1); // add xiaolei
	if(temperature2) DAVecRestoreArray(user->da, user->Tmprt2, &tmprt2); // add xiaolei
	if(temperature3) DAVecRestoreArray(user->da, user->Tmprt3, &tmprt3); // add xiaolei
	if(levelset) DAVecRestoreArray(user->da, user->Levelset, &level); // add xiaolei
